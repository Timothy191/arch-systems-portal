...
4. [x] Verify asset probe + HTTP 200 on `:3000`; PerformanceListener tests pass. Portal lint passes clean; pre-existing `tsc` errors in packages remain unrelated to this change.
