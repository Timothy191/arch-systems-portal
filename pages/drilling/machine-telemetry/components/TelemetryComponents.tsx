...
export function TelemetryMonthlySummary({
  monthlySummary,
  currentMonth,
}: {
...
export function TelemetryCurrentTable({
  telemetry,
  drills,
  maxBitDepth,
  machineId,
...
export function TelemetryArchives({
  archives,
}: {
  ...
  return (
    <GlassCard className="overflow-hidden p-0">
      <div className="p-4 border-b border-[var(--border-subtle)]">
        ...
        <p className="text-sm text-[var(--text-muted)] mt-1">
          Previous months telemetry data is automatically archived and preserved
          for safe keeping
        </p>
      </div>
