...
The repository is a pnpm-based monorepo with apps under apps/_ and shared packages under packages/_. The root orchestrates tooling via scripts and shared configs:
