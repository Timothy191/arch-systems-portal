...
- **Agent hooks (3 deployments)**:
  - _PreToolUse quality guard_: LLM reviews every Write/Edit for secrets, TODO stubs, and security issues before they land
  - _Stop WIP guard_: Reads Plans.md and warns you if you're about to close a session with unfinished `cc:WIP` tasks
  - _PostToolUse code review_: Lightweight haiku-powered review runs after every file write
