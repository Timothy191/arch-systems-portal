# Agents orchestrate; skills encode procedures

Canonical: [`STANDARD.md`](../STANDARD.md) · Source: [agentskills.io](https://agentskills.io/home)

Agents orchestrate; skills encode procedures. See `.cursor/standards/agent-skills/STANDARD.md` and `pnpm ai check`.
