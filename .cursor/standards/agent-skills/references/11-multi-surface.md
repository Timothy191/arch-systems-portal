# Cursor, Qoder, GitHub — one canonical procedure

Canonical: [`STANDARD.md`](../STANDARD.md) · Source: [agentskills.io](https://agentskills.io/home)

Cursor, Qoder, GitHub — one canonical procedure. See `.cursor/standards/agent-skills/STANDARD.md` and `pnpm ai check`.
