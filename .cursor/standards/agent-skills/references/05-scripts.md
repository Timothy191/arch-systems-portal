# Executable scripts — deterministic, idempotent wrappers

Canonical: [`STANDARD.md`](../STANDARD.md) · Source: [agentskills.io](https://agentskills.io/home)

Executable scripts — deterministic, idempotent wrappers. See `.cursor/standards/agent-skills/STANDARD.md` and `pnpm ai check`.
