# YAML name + description (trigger surface for routing)

Canonical: [`STANDARD.md`](../STANDARD.md) · Source: [agentskills.io](https://agentskills.io/home)

YAML name + description (trigger surface for routing). See `.cursor/standards/agent-skills/STANDARD.md` and `pnpm ai check`.
