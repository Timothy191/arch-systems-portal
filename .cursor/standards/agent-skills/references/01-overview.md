# Agent Skills overview — folders, discovery, progressive disclosure

Canonical: [`STANDARD.md`](../STANDARD.md) · Source: [agentskills.io](https://agentskills.io/home)

Agent Skills overview — folders, discovery, progressive disclosure. See `.cursor/standards/agent-skills/STANDARD.md` and `pnpm ai check`.
