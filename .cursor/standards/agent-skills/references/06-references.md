# On-demand docs; never duplicate SKILL.md body

Canonical: [`STANDARD.md`](../STANDARD.md) · Source: [agentskills.io](https://agentskills.io/home)

On-demand docs; never duplicate SKILL.md body. See `.cursor/standards/agent-skills/STANDARD.md` and `pnpm ai check`.
