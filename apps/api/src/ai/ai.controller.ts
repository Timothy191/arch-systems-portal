...
export class AiController {
  ...
  async handoff(
    @Body(new ZodValidationPipe(aiHandoffSchema))
  ...
  async predict(
    @Body(new ZodValidationPipe(aiPredictSchema))
    { machineData }: { machineData: string },
  ) {
  ...
  async safety(
    @Body(new ZodValidationPipe(aiSafetySchema))
