    ...
    <ErrorBoundary context={`Department Dashboard: ${deptSlug}`}>
      <div className="space-y-6 max-w-4xl mx-auto py-6">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl bg-[var(--accent-blue)]/10 flex items-center justify-center text-[var(--accent-blue)]">
        ...
        <GlassCard className="p-6 space-y-4">
          ...
          <p className="text-[var(--text-secondary)] leading-relaxed bg-[var(--bg-secondary)]/50 p-4 rounded-xl border border-[var(--border-subtle)]">
            {dbDept?.personality || "No personality defined for this department."}
          </p>
        </GlassCard>

        <GlassCard className="p-6">
          <h3 className="font-medium text-[var(--text-heading)] mb-4">Department Information</h3>
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div className="p-3 bg-[var(--bg-secondary)] rounded-lg">
              <span className="text-[var(--text-muted)] block mb-1">Slug</span>
              <span className="font-mono text-[var(--text-secondary)]">{deptSlug}</span>
            </div>
            <div className="p-3 bg-[var(--bg-secondary)] rounded-lg">
              <span className="text-[var(--text-muted)] block mb-1">ID</span>
              <span className="font-mono text-[var(--text-secondary)]">{deptId}</span>
            </div>
          </div>
        </GlassCard>
      </div>
