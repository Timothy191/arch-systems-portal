...
export async function ControlRoomReport({
  ...
  const totalBcm =
    excavatorAssignments?.reduce((sum, a) => sum + (a.total_bcm || 0), 0) || 0;
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[var(--text-muted)] text-sm mt-0.5">
                ...
                {missing.length !== 1 ? "s are" : " is"} missing entries for the
                current {currentShift} shift. Complete all entries first.
              </p>
            </div>
          </div>
